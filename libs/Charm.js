...
var Charm = (function () {
  ...
  _createClass(Charm, [{
    ...
    value: function slideEaseXY(sprite, endX, endY) {
      var frames = arguments[3] === undefined ? 60 : arguments[3];
      var typeX = arguments[4] === undefined ? "smoothstep" : arguments[4];
      var typeY = arguments[5] === undefined ? "smoothstep" : arguments[5];
      var yoyo = arguments[6] === undefined ? false : arguments[6];
      ...
      //Create the x axis tween
      [sprite, "x", sprite.x, endX, frames, typeX, yoyo, delayBeforeRepeat],

      //Create the y axis tween
      [sprite, "y", sprite.y, endY, frames, typeY, yoyo, delayBeforeRepeat]]);
    }
  }, {
    key: "rotate",

    value: function rotate(sprite, endRotation) {
      var frames = arguments[2] === undefined ? 60 : arguments[2];
      ...
      //tween the rotation
      return this.tweenProperty(sprite, "rotation", sprite.rotation, endRotation, frames, type, yoyo, delayBeforeRepeat);
    }
  }, {
    key: "breathe",
    ...
    value: function scale(sprite) {
      ...
      //Create the scaleX tween
      [sprite, "scaleX", sprite.scaleX, endScaleX, frames, type, false],

      //Create the scaleY tween
      [sprite, "scaleY", sprite.scaleY, endScaleY, frames, type, false]]);
    }
  }, {
    key: "strobe",
    ...
    value: function update() {
      ...
      console.log('globalTweens: ' + this.globalTweens.length);
